...
import { IPartialSwapRequest, NETWORKS, submitSwap, decimals, Token, Network } from "../lib/swapperd";
    ...
    public render(): JSX.Element {
        ...
        return (
            <>
                ...
                <div className="swap">
                    <p>{origin} is proposing the following swap on {NETWORKS[network as Network]}:</p>
